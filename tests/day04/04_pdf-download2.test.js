...
// Define a function to get the recommended filename
function recommendedFilename() {
  return 'HASAN_AKDOGAN_RESUME.pdf';
}
...
test.describe('PDF Download Test', () => {
  test('Save the PDF file that\'s downloaded', async ({ page }) => {
    ...
    const fileName = recommendedFilename(); // Use the recommended filename
